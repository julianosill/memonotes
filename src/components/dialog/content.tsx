...
export function Content({ children, className, ...props }: ContentProps) {
  return (
    <Dialog.Portal>
      <Dialog.Overlay className="fixed inset-0 z-20 bg-memonotes-950/90 backdrop-blur-sm dark:bg-zinc-950/90" />
      <Dialog.Content
        className={twMerge(
          'fixed inset-0 z-20 flex h-screen w-full max-w-[720px] flex-col justify-center overflow-y-auto bg-card p-8 sm:p-12',
